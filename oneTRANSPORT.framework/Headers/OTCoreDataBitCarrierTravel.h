...
#define kCoreDataEntityBitCarrierTravel @"BC_Travel"
#define kUserDefaultsStampBitCarrierTravel @"oneT_UserDefaultsStampBitCarrierTravel"

@class BC_Travel;

@interface OTCoreDataBitCarrierTravel : OTCoreDateBaseTsv
 ...
 */
- (NSArray <BC_Travel *> * _Nonnull)populateTableWith:(id _Nonnull)data timestamp:(NSDate * _Nonnull)date;
 ...
 */
- (NSArray <BC_Travel *> * _Nonnull)checkForChanges:(NSArray <NSDictionary *> * _Nonnull)arrayCommon;
