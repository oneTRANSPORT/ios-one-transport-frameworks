...
#define kCoreDataEntityBitCarrierSketch @"BC_Sketch"
#define kUserDefaultsStampBitCarrierSketch @"oneT_UserDefaultsStampBitCarrierSketch"

@class BC_Sketch;

@interface OTCoreDataBitCarrierSketch : OTCoreDateBaseTsv
 ...
 */
- (NSArray <BC_Sketch *> * _Nonnull)populateTableWith:(id _Nonnull)data timestamp:(NSDate * _Nonnull)date;
 ...
 */
- (NSArray <BC_Sketch *> * _Nonnull)checkForChanges:(NSArray <NSDictionary *> * _Nonnull)arrayCommon;
