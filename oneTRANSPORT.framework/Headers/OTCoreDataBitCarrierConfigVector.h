//
//  OTCoreDataBitCarrierConfigVector.h
//  oneTRANSPORT
//
...
#define kCoreDataEntityBitCarrierConfigVector @"BC_ConfigVector"
#define kUserDefaultsStampBitCarrierConfigVector @"oneT_UserDefaultsStampBitCarrierConfigVector"

@class BC_ConfigVector;

@interface OTCoreDataBitCarrierConfigVector : OTCoreDateBaseTsv
 ...
 */
- (NSArray <BC_ConfigVector *> * _Nonnull)populateTableWith:(id _Nonnull)data timestamp:(NSDate * _Nonnull)date;
 ...
 */
- (NSArray <BC_ConfigVector *> * _Nonnull)checkForChanges:(NSArray <NSDictionary *> * _Nonnull)arrayCommon;
